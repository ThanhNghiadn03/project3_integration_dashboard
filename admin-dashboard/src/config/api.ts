...
export const callCreateUser = (user: IUser) => {
    return axios.post<IBackendRes<IUser>>('/api/employee', { ...user })
}

export const callUpdateUser = (user: IUser) => {
    return axios.patch<IBackendRes<IUser>>(`/api/employee`, { ...user })
}

export const callDeleteUser = (id: string) => {
    return axios.delete<IBackendRes<IUser>>(`/api/employee/${id}`);
}

export const callFetchUser = () => {
    const result = axios.get<IBackendRes<IUser>>(`/api/employee`);
    console.log(result);
    return result;
}
